...
public class SessionUtils {
    ...
    //从session域获取用户的购物车对象
    public static ShopingCart getCurrentCart(){
        return   (ShopingCart) getSession().getAttribute(CART_IN_SESSION);
    }

    //往Session域存放购物车
    public static void setCartInSession(ShopingCart cart){
        if(cart != null){
