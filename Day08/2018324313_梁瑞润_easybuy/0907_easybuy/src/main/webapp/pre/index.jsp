...
<div class="menu_bg">
    <div class="menu">
        ...
        <ul class="menu_r">
            ...
            <c:forEach items="${productCategoryVoList}" var="temp">
                <li>
                    <a href="${ctx}/Product/queryProductList?level=1&category=${temp.productCategory.id}">${temp.productCategory.name}</a>
                </li>
            </c:forEach>
        </ul>
...
<div class="i_bg bg_color">
        ...
        <div class="inews">
            ...
            <ul>
                <c:forEach items="${news}" var="temp">
                    <li><span>[ 公告 ]</span>
                        <a href="${ctx}/admin/news/newsDeatil?id=${temp.id}">${temp.title}</a>
                    </li>
                </c:forEach>
            </ul>
            <div class="charge_t">
    ...
    <!--Begin 进口 生鲜 Begin-->
    <c:forEach items="${productCategoryVoList}" var="temp" varStatus="status">
